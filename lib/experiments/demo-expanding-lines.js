...
(function() {
  'use strict';
  var $, $async, $watch, CND, FS, MIRAGE, PATH, PD, abspath, assign, badge, debug, declare, do_validate, echo, first, help, info, isa, jr, last, relpath, rpr, select, size_of, stamp, type_of, types, urge, validate, warn, whisper;
