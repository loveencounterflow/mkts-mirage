...
(function() {
  'use strict';
  var $, $async, CND, FS, L, PATH, PD, PSPG, TMP, _$count, abspath, as_sql, assign, badge, debug, declare, echo, help, info, isa, jr, last_of, relpath, rpr, select, size_of, testing, type_of, types, urge, validate, warn, whisper,
  ...
  this.$as_sql = () => {
    ...
    return $({first, last}, (line, send) => {
      ...
      if (line === first) {
        ...
        send("    line      text );");
        return send("insert into main ( lnr, line ) values");
      //.......................................................................................................
      } else if (line === last) {
        send(";");
        return send("create unique index idx_main_lnr on main ( lnr );");
      } else {
        //.......................................................................................................
        lnr += +1;
  ...
  this.new_settings = function(settings) {
    ...
    R.target_filename_sql = 'main.sql';
...
//# sourceMappingURL=text-to-table.js.map
