...
(function() {
  'use strict';
  var $, $async, CND, ICQL, PATH, PD, _drop_extension, assign, badge, boolean_as_int, cast, cwd_abspath, cwd_relpath, debug, declare, echo, help, here_abspath, info, inspect, isa, join_path, jr, last_of, project_abspath, rpr, select, size_of, type_of, types, urge, validate, warn, whisper, xrpr, xrpr2;
