...
(function() {
  'use strict';
  var $, $async, CND, FS, L, PATH, PD, TMP, _$count, abspath, as_sql, assign, badge, debug, declare, echo, help, info, isa, jr, last_of, relpath, rpr, select, size_of, testing, type_of, types, urge, validate, warn, whisper,
  ...
  this.$as_sql = () => {
    ...
    return $({first, last}, (line, send) => {
      ...
      if (line === first) {
        ...
        send("    line      text );");
        return send("insert into main ( vlnr, line ) values");
      //.......................................................................................................
      } else if (line === last) {
        send(";");
